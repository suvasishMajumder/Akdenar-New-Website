...
export default function Navbar() {
    ...
    return (
        <>
            ...
            {/* MOBILE DRAWER */}
            <div
                className={`fixed top-0 left-0 h-full w-72 bg-white shadow-xl p-6 z-50 transform transition-transform duration-300 ${open ? "translate-x-0" : "-translate-x-full"
                    }`}
            >
                {/* Drawer Header */}
                <div className="flex items-center justify-between mb-6">
                    ...
                    <button onClick={() => setOpen(false)} className="transition-transform active:scale-90">
                        <X size={26} />
                    </button>
                </div>
