    ...
    return (
        ...
        "
          ...
          "
            ...
            "
                        >
                            At Akdenar, we don’t just build technology; we build institutions that
                            stand the test of time. By merging the high-tech velocity of Akdenar Labs
                            with the social soul of Deshmitra, we are shaping a future that is
                            efficient, trusted, and inclusive.
                        </p>
...
function CompanyOverview() {
    return (
        <section className="w-full px-6 md:px-12 py-16 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                ...
                <div>
                    ...
                    <p className="text-gray-700 text-sm md:text-base leading-relaxed">
                        Akdenar operates at the intersection of cutting-edge technology and deep
                        social impact. We are an ecosystem of builders — comprising Akdenar Labs,
                        our innovation engine for intelligent products and Aurora OS, and Deshmitra,
                        our community-focused arm dedicated to sustainable development.
                        <br /><br />
                        We believe that only the paranoid survive, which is why we constantly reinvent
                        ourselves. We don’t just chase trends; we build resilient systems. Whether it’s
                        rapid prototyping in our Innovation Studio or mapping health needs in underserved
                        regions, our focus remains the same: creating lasting value for people and the planet.
                    </p>
                </div>
    ...
    return (
        <section className="w-full px-6 md:px-12 py-20 max-w-7xl mx-auto">
            ...
            <div className="text-center max-w-3xl mx-auto mb-16">
                <h2 className="text-3xl md:text-4xl font-bold">Two Engines, One Mission</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 place-items-center gap-12 mb-20">
                ...
                <div>
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-sm">Impact That Touches Every Community</p>
                        </div>
                    </div>

                    <p className="text-gray-700 text-sm md:text-base leading-relaxed mb-5">
                        Deshmitra is the heart of our social commitment. It is not just a CSR
                        initiative; it is a dedicated operation focused on lifting underserved
                        regions through data-driven development.
                    </p>

                    <ul className="text-gray-700 text-sm md:text-base space-y-3">
                        <li className="flex items-start gap-2">
                            <span className="text-green-600 text-lg">✔</span>
                            <p><strong>Listening First:</strong> We believe solutions start with understanding. Deshmitra recently launched a nationwide survey to map local health and infrastructure needs across rural communities.</p>
                        </li>

                        <li className="flex items-start gap-2">
                            <span className="text-green-600 text-lg">✔</span>
                            <p><strong>Measurable Action:</strong> We prioritize projects that offer tangible results—whether it’s improving local healthcare access or creating sustainable economic opportunities.</p>
                        </li>

                        <li className="flex items-start gap-2">
                            <span className="text-green-600 text-lg">✔</span>
                            <p><strong>The Goal:</strong> To ensure that as the world advances, no community is left behind.</p>
                        </li>
                    </ul>
                </div>
                ...
                <div
                    ...
                    p-10 flex items-center h-80 justify-center bg-gradient-to-b from-white to-[#e9e7ff]"> <img
                ...
                <div>
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-sm">Where Ideas Become Innovation</p>
                        </div>
                    </div>
                    ...
                    <ul className="text-gray-700 text-sm md:text-base space-y-3">
                        <li className="flex items-start gap-2">
                            ...
                            <p><strong>The Innovation Studio:</strong> A creative sandbox for rapid prototyping and research, turning abstract concepts into market-ready products.</p>
                        </li>

                        <li className="flex items-start gap-2">
                            <span className="text-blue-600 text-lg">✔</span>
                            <p><strong>Aurora OS 2.0:</strong> Our flagship technology update introducing contextual interfaces and smart UX patterns.</p>
                        </li>

                        <li className="flex items-start gap-2">
                            <span className="text-blue-600 text-lg">✔</span>
                            <p><strong>The Focus:</strong> Merging emerging technologies with human-centric design to create products that feel intuitive and inclusive.</p>
                        </li>
                    </ul>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-gray-700 text-sm md:text-base leading-relaxed">
                        <li className="flex items-start gap-2">
                            <span className="text-blue-600 text-lg">•</span>
                            <p><strong>Headquarters:</strong> New Delhi, India (The heart of our operations).</p>
                        </li>

                        <li className="flex items-start gap-2">
                            <span className="text-blue-600 text-lg">•</span>
                            <p><strong>Regional Offices:</strong> Gujarat, Bihar.</p>
                        </li>

                        <li className="flex items-start gap-2">
                            <span className="text-blue-600 text-lg">•</span>
                            <p><strong>Active Projects:</strong> 40+ In Different Domain</p>
                        </li>

                        <li className="flex items-start gap-2">
                            <span className="text-blue-600 text-lg">•</span>
                            <p><strong>Remote Team Members:</strong> Working from multiple states</p>
                        </li>
                    </ul>
                </div>
...
function Leadership() {
    ...
    return (
        <section className="w-full px-6 md:px-12 py-10 max-w-6xl mx-auto text-center">
            ...
            {/* Heading */}
            <h2 className="text-3xl md:text-4xl font-bold">Led by Visionaries</h2>

            {/* Subheading */}
            <p className="text-gray-600 text-sm md:text-base mt-3 mb-16 max-w-2xl mx-auto">
