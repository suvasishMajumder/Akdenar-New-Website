...
import { Mail, Phone, MapPin, Instagram, Facebook, Linkedin, HelpCircle } from "lucide-react";
          ...
          "
            ...
            "
                        >
                            ...
                            to hearing from you and exploring opportunities for collaboration.                    </p>
                    ...
                    <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
                        ...
                        <ul className="space-y-3 text-gray-700 text-sm leading-relaxed">
                            <li className="flex gap-2">
                                ...
                                Third Floor, 69, New Mangalpuri, New Delhi,
                                Delhi 110030, India
                            </li>
                            <li className="flex gap-2">
